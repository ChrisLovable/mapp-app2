...
export default function Home({ onShowAuth }) {
    ...
    useEffect(() => {
        window.showInstallingOverlay = () => setShowInstallingOverlay(true);
        return () => { delete window.showInstallingOverlay; };
    }, []);
