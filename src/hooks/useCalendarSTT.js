...
export const useCalendarSTT = ({ formData, setFormData, editingFormData, setEditingFormData, setCurrentDate, setShowEventForm, showNotification }) => {
    const [isListening, setIsListening] = useState(null);
    // STT Result Handlers
    const handleTitleSTTResult = (text) => {
        console.log('🎤 Title STT Result:', text);
        setFormData({ ...formData, title: text });
        showNotification('Title updated via voice!', 'success');
    };
    const handleAttendeesSTTResult = (text) => {
