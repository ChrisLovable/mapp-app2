    ...
    async generateImage(options) {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                apiUsageTracker.trackOpenAIUsage('/api/replicate/predictions', 'replicate', 0, 0, referenceImage ? 'Image Transformation' : 'Image Generation', false, errorText);
                return {
                    success: false,
            ...
            apiUsageTracker.trackOpenAIUsage('/api/replicate/predictions', 'replicate', 0, 0, referenceImage ? 'Image Transformation' : 'Image Generation', true);
            return {
                success: true,
                imageUrl,
                usage: {
            ...
            apiUsageTracker.trackOpenAIUsage('/api/replicate/predictions', 'replicate', 0, 0, 'Image Generation', false, error instanceof Error ? error.message : 'Unknown error');
            return {
                success: false,
